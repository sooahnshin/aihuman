...
The package provides main functions for the methods proposed by [Eli, Greiner, Huang, Imai, Jiang, and Shin (2024)](https://arxiv.org/pdf/2403.12108) based on a minimal set of assumptions.
...
For more details, see the `ablity` vignette, `vignette("ablity", package = "aihuman")`.
