...
#' \itemize{
#'   \item{X}{Pretreatment covariate (if provided).}
#'   \item{agree_diff}{Difference in agreement between human decisions and AI recommendations.}
#'   \item{agree_diff_se}{Standard error of the difference in agreement.}
#' }
#'
#' @importFrom magrittr %>%
...
#' @return A tibble with the following columns:
#' \itemize{
#'   \item{cov}{Subgroup label.}
#'   \item{X}{Subgroup value.}
#'   \item{agree_diff}{Difference in agreement between human decisions and AI recommendations.}
#'   \item{agree_diff_se}{Standard error of the difference in agreement.}
#'   \item{ci_lb}{Lower bound of the 95\% confidence interval.}
#'   \item{ci_ub}{Upper bound of the 95\% confidence interval.}
#' }
